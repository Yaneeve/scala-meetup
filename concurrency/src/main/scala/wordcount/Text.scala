...
object Text {
  ...
  val aTaleOfTwoCitiesRAW = raw"""It was the best of times, it was the worst of times,
...
"""
  ...
  val aTaleOfTwoCities: Array[String] = Text.aTaleOfTwoCitiesRAW.split(raw"\s+").map(_.replaceAll("[,|.]", ""))
